...
public class DiffMatchPatchTests : DiffMatchPatch
{
    ...
    public void DiffHalfMatchTest()
    {
        ...
        AssertNull("diff_halfMatch: No match #1.", this.DiffHalfMatch("1234567890".ToRope(), "abcdef".ToRope(), this.DiffOptions));

        AssertNull("diff_halfMatch: No match #2.", this.DiffHalfMatch("12345".ToRope(), "23".ToRope(), this.DiffOptions));

        AssertEquals("diff_halfMatch: Single Match #1.", new HalfMatch("12", "90", "a", "z", "345678"), this.DiffHalfMatch("1234567890".ToRope(), "a345678z".ToRope(), this.DiffOptions));

        AssertEquals("diff_halfMatch: Single Match #2.", new HalfMatch("a", "z", "12", "90", "345678"), this.DiffHalfMatch("a345678z".ToRope(), "1234567890".ToRope(), this.DiffOptions));

        AssertEquals("diff_halfMatch: Single Match #3.", new HalfMatch("abc", "z", "1234", "0", "56789"), this.DiffHalfMatch("abc56789z".ToRope(), "1234567890".ToRope(), this.DiffOptions));

        AssertEquals("diff_halfMatch: Single Match #4.", new HalfMatch("a", "xyz", "1", "7890", "23456"), this.DiffHalfMatch("a23456xyz".ToRope(), "1234567890".ToRope(), this.DiffOptions));

        AssertEquals("diff_halfMatch: Multiple Matches #1.", new HalfMatch("12123", "123121", "a", "z", "1234123451234"), this.DiffHalfMatch("121231234123451234123121".ToRope(), "a1234123451234z".ToRope(), this.DiffOptions));

        AssertEquals("diff_halfMatch: Multiple Matches #2.", new HalfMatch("", "-=-=-=-=-=", "x", "", "x-=-=-=-=-=-=-="), this.DiffHalfMatch("x-=-=-=-=-=-=-=-=-=-=-=-=".ToRope(), "xx-=-=-=-=-=-=-=".ToRope(), this.DiffOptions));

        AssertEquals("diff_halfMatch: Multiple Matches #3.", new HalfMatch("-=-=-=-=-=", "", "", "y", "-=-=-=-=-=-=-=y"), this.DiffHalfMatch("-=-=-=-=-=-=-=-=-=-=-=-=y".ToRope(), "-=-=-=-=-=-=-=yy".ToRope(), this.DiffOptions));

        // Optimal diff would be -q+x=H-i+e=lloHe+Hu=llo-Hew+y not -qHillo+x=HelloHe-w+Hulloy
        AssertEquals("diff_halfMatch: Non-optimal halfmatch.", new HalfMatch("qHillo", "w", "x", "Hulloy", "HelloHe"), this.DiffHalfMatch("qHilloHelloHew".ToRope(), "xHelloHeHulloy".ToRope(), this.DiffOptions));

        this.DiffOptions = this.DiffOptions with
        {
            TimeoutSeconds = 0
        };
        AssertNull("diff_halfMatch: Optimal no halfmatch.", this.DiffHalfMatch("qHilloHelloHew".ToRope(), "xHelloHeHulloy".ToRope(), this.DiffOptions));
    }
    ...
    public void DiffLinesToCharsTest()
    {
        ...
        tmpVector += "alpha\n".ToRope();
        tmpVector += "beta\n".ToRope();
        var result = this.DiffLinesToChars("alpha\nbeta\nalpha\n".ToRope(), "beta\nalpha\nbeta\n".ToRope());
        ...
        tmpVector += "beta\r\n".ToRope();
        tmpVector += "\r\n".ToRope();
        result = this.DiffLinesToChars("".ToRope(), "alpha\r\nbeta\r\n\r\n\r\n".ToRope());
        ...
        tmpVector += "a".ToRope();
        tmpVector += "b".ToRope();
        result = this.DiffLinesToChars("a".ToRope(), "b".ToRope());
        ...
        result = this.DiffLinesToChars(lines, "".ToRope());
    ...
    public void DiffCharsToLinesTest()
    {
        ...
        diffs = this.DiffCharsToLines(diffs, tmpVector);
        ...
        diffs = this.DiffCharsToLines(diffs, result.Lines);
    ...
    public void DiffCleanupSemanticLosslessTest()
    {
        ...
        var diffs = Rope<Diff<char>>.Empty;
        diffs = this.DiffCleanupSemanticLossless(diffs);
    ...
    public void DiffCleanupSemanticTest()
    {
        ...
        // Null case.
        var diffs = Rope<Diff<char>>.Empty;
        diffs = this.DiffCleanupSemantic(diffs);
    ...
    public void DiffCleanupEfficiencyTest()
    {
        ...
        var diffs = Rope<Diff<char>>.Empty;
        diffs = this.DiffCleanupEfficiency(diffs, this.DiffOptions);
    ...
    public void DiffTextTest()
    {
        ...
        AssertEquals("diff_text2:", "jumped over a lazy".ToRope(), diffs.ToDestination());
    }
    ...
    public void DiffXIndexTest()
    {
        ...
        new Diff<char>(Operation.EQUAL, "xyz")});
        AssertEquals("diff_xIndex: Translation on equality.", 5, (int)diffs.TranslateToDestinationIndex(2));

        diffs = new Rope<Diff<char>>(new[] {
        new Diff<char>(Operation.EQUAL, "a"),
        new Diff<char>(Operation.DELETE, "1234"),
        new Diff<char>(Operation.EQUAL, "xyz")});
        AssertEquals("diff_xIndex: Translation on deletion.", 1, (int)diffs.TranslateToDestinationIndex(3));
    }
    ...
    public void DiffBisectTest()
    {
        ...
        AssertEquals("diff_bisect: Normal.", diffs, this.DiffBisect(a, b, this.DiffOptions, CancellationToken.None));
        ...
        AssertEquals("diff_bisect: Timeout.", diffs, this.DiffBisect(a, b, this.DiffOptions, timedOut.Token));
    }
    ...
    public void CalculateDifferencesTest()
    {
        ...
        AssertEquals("diff_main: Null case.", diffs, this.CalculateDifferences("", "", false));

        diffs = new Rope<Diff<char>>(new[] { new Diff<char>(Operation.EQUAL, "abc") });
        AssertEquals("diff_main: Equality.", diffs, this.CalculateDifferences("abc", "abc", false));
        ...
        AssertEquals("diff_main: Simple insertion.", diffs, this.CalculateDifferences("abc", "ab123c", false));
        ...
        AssertEquals("diff_main: Simple deletion.", diffs, this.CalculateDifferences("a123bc", "abc", false));
        ...
        AssertEquals("diff_main: Two insertions.", diffs, this.CalculateDifferences("abc", "a123b456c", false));
        ...
        AssertEquals("diff_main: Two deletions.", diffs, this.CalculateDifferences("a123b456c", "abc", false));
        ...
        AssertEquals("diff_main: Simple case #1.", diffs, this.CalculateDifferences("a", "b", false));
        ...
        AssertEquals("diff_main: Simple case #2.", diffs, this.CalculateDifferences("Apples are a fruit.", "Bananas are also fruit.", false));
        ...
        AssertEquals("diff_main: Simple case #3.", diffs, this.CalculateDifferences("ax\t", "\u0680x" + (char)0, false));
        ...
        AssertEquals("diff_main: Overlap #1.", diffs, this.CalculateDifferences("1ayb2", "abxab", false));
        ...
        AssertEquals("diff_main: Overlap #2.", diffs, this.CalculateDifferences("abcy", "xaxcxabc", false));
        ...
        AssertEquals("diff_main: Overlap #3.", diffs, this.CalculateDifferences("ABCDa=bcd=efghijklmnopqrsEFGHIJKLMNOefg", "a-bcd-efghijklmnopqrs", false));
        ...
        AssertEquals("diff_main: Large equality.", diffs, this.CalculateDifferences("a [[Pennsylvania]] and [[New", " and [[Pennsylvania]]", false));

#if DEBUG
        this.DiffOptions = this.DiffOptions with { TimeoutSeconds = 0.2f };// 200ms
#else
        this.Options = this.Options with { TimeoutSeconds = 0.1f }; // 100ms
#endif
        ...
        _ = this.CalculateDifferences(a, b);
        s.Stop();
        ...
        a = "1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n";
        b = "abcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\nabcdefghij\n";
        AssertEquals("diff_main: Simple line-mode.", this.CalculateDifferences(a, b, true), this.CalculateDifferences(a, b, false));

        a = "1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890";
        b = "abcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghij";
        AssertEquals("diff_main: Single line-mode.", this.CalculateDifferences(a, b, true), this.CalculateDifferences(a, b, false));

        a = "1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n1234567890\n";
        b = "abcdefghij\n1234567890\n1234567890\n1234567890\nabcdefghij\n1234567890\n1234567890\n1234567890\nabcdefghij\n1234567890\n1234567890\n1234567890\nabcdefghij\n";
        var texts_linemode = this.CalculateDifferences(a, b, true).ToSourceAndDestination();
        var texts_textmode = this.CalculateDifferences(a, b, false).ToSourceAndDestination();
    ...
    public void MatchAlphabetTest()
    {
        ...
        AssertEquals("match_alphabet: Unique.", bitmask, this.MatchAlphabet("abc".ToRope()));

        bitmask.Clear();
        bitmask.Add('a', 37); bitmask.Add('b', 18); bitmask.Add('c', 8);
        AssertEquals("match_alphabet: Duplicates.", bitmask, this.MatchAlphabet("abcaba".ToRope()));
    }
    ...
    public void PatchAddContextTest()
    {
        ...
        p = this.PatchAddContext(p, "The quick brown fox jumps over the lazy dog.".ToRope(), this.PatchOptions);
        AssertEquals("patch_addContext: Simple case.", "@@ -17,12 +17,18 @@\n fox \n-jump\n+somersault\n s ov\n", p.ToString());

        p = this.ParsePatchText("@@ -21,4 +21,10 @@\n-jump\n+somersault\n")[0];
        p = this.PatchAddContext(p, "The quick brown fox jumps.".ToRope(), this.PatchOptions);
        ...
        p = this.ParsePatchText("@@ -3 +3,2 @@\n-e\n+at\n")[0];
        p = this.PatchAddContext(p, "The quick brown fox jumps.  The quick brown fox crashes.".ToRope(), this.PatchOptions);
    ...
    public void PatchSplitMaxTest()
    {
        ...
        patches = this.CreatePatches("abcdefghijklmnopqrstuvwxyz01234567890", "XabXcdXefXghXijXklXmnXopXqrXstXuvXwxXyzX01X23X45X67X89X0");
        patches = this.PatchSplitMaxLength(patches, this.PatchOptions);
        AssertEquals("patch_splitMax: #1.", "@@ -1,32 +1,46 @@\n+X\n ab\n+X\n cd\n+X\n ef\n+X\n gh\n+X\n ij\n+X\n kl\n+X\n mn\n+X\n op\n+X\n qr\n+X\n st\n+X\n uv\n+X\n wx\n+X\n yz\n+X\n 012345\n@@ -25,13 +39,18 @@\n zX01\n+X\n 23\n+X\n 45\n+X\n 67\n+X\n 89\n+X\n 0\n", this.ToPatchText(patches));

        patches = this.CreatePatches("abcdef1234567890123456789012345678901234567890123456789012345678901234567890uvwxyz", "abcdefuvwxyz");
        string oldToText = this.ToPatchText(patches);
        patches = this.PatchSplitMaxLength(patches, this.PatchOptions);
        AssertEquals("patch_splitMax: #2.", oldToText, this.ToPatchText(patches));

        patches = this.CreatePatches("1234567890123456789012345678901234567890123456789012345678901234567890", "abc");
        patches = this.PatchSplitMaxLength(patches, this.PatchOptions);
        AssertEquals("patch_splitMax: #3.", "@@ -1,32 +1,4 @@\n-1234567890123456789012345678\n 9012\n@@ -29,32 +1,4 @@\n-9012345678901234567890123456\n 7890\n@@ -57,14 +1,3 @@\n-78901234567890\n+abc\n", this.ToPatchText(patches));

        patches = this.CreatePatches("abcdefghij , h : 0 , t : 1 abcdefghij , h : 0 , t : 1 abcdefghij , h : 0 , t : 1", "abcdefghij , h : 1 , t : 1 abcdefghij , h : 1 , t : 1 abcdefghij , h : 0 , t : 1");
        patches = this.PatchSplitMaxLength(patches, this.PatchOptions);
    ...
    {
        IEnumerable<Patch<char>> patches;
        patches = this.CreatePatches("", "test");
        ...
        patches = this.CreatePatches("XY", "XtestY");
        ...
        patches = this.CreatePatches("XXXXYYYY", "XXXXtestYYYY");
    ...
    public void PatchApplyTest()
    {
        ...
        patches = this.CreatePatches("The quick brown fox jumps over the lazy dog.", "That quick brown fox jumped over a lazy dog.");
        ...
        patches = this.CreatePatches("x1234567890123456789012345678901234567890123456789012345678901234567890y", "xabcy");
        ...
        patches = this.CreatePatches("abcdefghijklmnopqrstuvwxyz--------------------1234567890", "abcXXXXXXXXXXdefghijklmnopqrstuvwxyz--------------------1234567YYYYYYYYYY890");
        ...
        patches = this.CreatePatches("The quick brown fox jumps over the lazy dog.", "Woof");
        ...
        patches = this.CreatePatches("y", "y123");
